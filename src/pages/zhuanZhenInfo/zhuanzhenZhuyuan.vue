<template>
    <div class="printDetail"  ref="printContent">
        <div class="textAlignCenter title">{{getInforli.ApplyHospitalName}}转诊单</div>
        <el-breadcrumb-item class="formWidth">送转信息</el-breadcrumb-item>
          <el-form v-model="turnlist" label-width="110px" class="clearfix worddisplay">
            <el-row>
              <el-col :span='12'>
                <el-form-item label="转诊编号：">{{getInforli.TransferNo}}</el-form-item>
              </el-col>
              <el-col :span='12'>
                <el-form-item label="转入医院：">{{getInforli.AppointmentHospitalName}}</el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='12'>
                <el-form-item label="转入科室：">{{getInforli.AppointmentSectionName}}</el-form-item>
              </el-col>
              <el-col :span='12'>
                <el-form-item label="申请入住日期：">{{jiequ(getInforli.AppointmentPlanDate)}}</el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='12'>
                <el-form-item label="预计住院天数：">{{getInforli.AppointmentPlanDayNum==0?'':getInforli.AppointmentPlanDayNum}}</el-form-item>
              </el-col>
              <el-col :span='12'>
                <el-form-item label="转出医院：">{{getInforli.ApplyHospitalName}}</el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='12'>
                <el-form-item label="转出科室：">{{getInforli.ApplySectionName}}</el-form-item>
              </el-col>
              <el-col :span='12'>
                <el-form-item label="转出医院联系人：">{{getInforli.ApplyDoctorName}}</el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='12'>
                <el-form-item label="手机号码：">{{getInforli.ApplyDoctorPhone}}</el-form-item>
              </el-col>
            </el-row>
            <el-breadcrumb-item class="formWidth">病人信息</el-breadcrumb-item>
            <el-row>
              <el-col :span='12'>
                <el-form-item label="病人姓名：">{{getInforli.PatientName}}</el-form-item>
              </el-col>
              <el-col :span='12'>
                <el-form-item label="性别：">{{getInforli.PatientSex=='0'?'女':'男'}}</el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='12'>
            ...
            <el-row>
              <el-col :span='12'>
                <el-form-item label="手机号码：">{{getInforli.PatientPhone}}</el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='24'>
                <el-form-item label="病人居住地址：">{{getInforli.Province}}{{getInforli.City}}{{getInforli.Area}}{{getInforli.DetailedAddress}}</el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='24'>
                <el-form-item label="主要诊断：">{{getInforli.Diagnose}}</el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='24'>
                <el-form-item label="病情描述：">{{getInforli.PatientCondition}}</el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='24'>
                <el-form-item label="病人主诉：">{{getInforli.PatientComplaint}}</el-form-item>
              </el-col>
            </el-row>
          </el-form>
          <div class="posbottom">
                ...
                <div class="con_ul clearfix marginleft20">
                    ...
                    <p class="con_con">1.凭此转诊单，携带身份证,医保卡等前往转入医院办理入院手续。</p>
